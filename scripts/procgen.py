...
def generate_dungeon(map_width, map_height) -> GameMap:
    ...
    room_1 = RectangularRoom(x=20, y=16, width=10, height=15)
    room_2 = RectangularRoom(x=36, y=16, width=10, height=15)

    dungeon.tiles[room_1.inner] = scripts.tile_types.floor
    dungeon.tiles[room_2.inner] = scripts.tile_types.floor
